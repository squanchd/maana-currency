var initTracer = require('./middleware/tracing')
...
async function trace(resolve, root, args, context, info) {
  ...
  span.setTag('graphql.args', args)
  span.setTag('graphql.info', info)
